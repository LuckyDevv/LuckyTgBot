...
<h3>Текст информации о боте вы можете изменить в файле info.txt. В конце, пожалуйста, укажите ссылку на изначальный GitHub бота.</h3>
...
def get_name(self, cid): # Возвращает Telegram имя игрока
```
...
`user_name` - Telegram имя игрока, тип данных - TEXT
